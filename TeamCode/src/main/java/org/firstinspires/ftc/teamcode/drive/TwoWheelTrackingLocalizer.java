...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double WHEEL_RADIUS = .944882; // in 0.688976378
    public static double GEAR_RATIO = 1; // output (wheel) speed / input (encoder) speed

    public static double PARALLEL_X = -2.5; // X is the up and down direction
    public static double PARALLEL_Y = -4.85; // Y is the strafe direction

    public static double PERPENDICULAR_X = 7;
    public static double PERPENDICULAR_Y = -3;
    public static double X_MULTIPLIER = ((50.0/50.3882)+(50.0/50.4448)+(50.0/50.5929))/3.0;// 0.99338783679
    public static double Y_MULTIPLIER = ((50.0/50.0286)+(50.0/50.6799)+(50.0/50.7853))/3.0;//1.0063490194
