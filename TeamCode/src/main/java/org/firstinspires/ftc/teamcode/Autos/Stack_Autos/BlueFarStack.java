...
public class BlueFarStack extends LinearOpMode {
	...
	public static double centerSplineToLinearHeading2X = 27, centerSplineToLinearHeading2Y = 79, centerSplineToLinearHeading2EndTangent = 75, centerSplineToLinearHeading2Heading = 90;

	public static double leftSplineToLinearHeading2X = 22.5, leftSplineToLinearHeading2Y = 79, leftSplineToLinearHeading2EndTangent = 75, leftSplineToLinearHeading2Heading = 90;

	public static double rightSplineToLinearHeading2X = 31.5, rightSplineToLinearHeading2Y = 79, rightSplineToLinearHeading2EndTangent = 75, rightSplineToLinearHeading2Heading = 90;
